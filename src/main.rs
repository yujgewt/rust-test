...
fn ShiftRows(mut text:[u8;16]){

    println!("ShiftRows -> {:?}",text);
...
fn G(mut a:u32, round:u8)->u32{
    println!("input value : {}",a);
    a = RotateLeft(a,1);
    println!("rotated value : {}",a);
    // u32 -> [u8;4]
